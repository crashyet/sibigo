...
const Contact = () => {
  return (
    <section id='contact' className='container mx-auto px-6 md:px-20 lg:px-32 py-12 md:py-20 font-pjs'>
      {/* Top Banner */}
      <div className="flex items-center justify-center border-2 border-[#3338A0] rounded-full py-3 md:py-4 mb-10 md:mb-20 max-w-7xl mx-auto animate-on-scroll" data-animation="animate-fade-up">
        <h2 className="font-bold text-3xl md:text-4xl text-[#1E2B63]">Contact Us</h2>
      </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="bg-[#F0F3FF] rounded-3xl p-6 flex items-center gap-6 text-[#1E2B63]">
                ...
                <div>
                  <h5 className="font-bold text-xl">Nomer Telephone</h5>
                  <p className="text-sm opacity-80">+62 856 9555 4326</p>
                </div>
              </div>
              ...
              <div className="bg-[#F0F3FF] rounded-3xl p-6 flex items-center gap-6 text-[#1E2B63]">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-80">sibigo@gmail.com</p>
                </div>
              </div>
              ...
              <div className="bg-[#F0F3FF] rounded-3xl p-6 flex items-center gap-6 text-[#1E2B63]">
                ...
                <div>
                  <h5 className="font-bold text-xl">Alamat</h5>
                  <p className="text-sm opacity-80 leading-snug">Jl. Dr. Soetomo, Karangcengis, Kabupaten Cilacap</p>
                </div>
              </div>
            </div>
          </div>
