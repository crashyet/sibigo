  ...
  return (
    <section id='home' className="relative px-6 md:px-20 lg:px-40 min-h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col lg:flex-row lg:h-screen items-center pt-24 md:pt-28 lg:pt-0 lg:mt-20">
        ...
        <div className="flex flex-col flex-1 gap-8 md:gap-12 lg:gap-16 lg:-mt-48 z-10 animate-on-scroll" data-animation="animate-fade-left">
          ...
          <div className="flex flex-col sm:flex-row gap-6 md:gap-10 lg:gap-20 items-start sm:items-center">
            <button className="bg-[#FCC61D] text-[#f7f7f7] w-full sm:w-56 md:w-72 lg:w-88 rounded-3xl font-pjs font-bold text-lg md:text-xl py-2.5 shadow-[0_5px_0_#C59560] hover:bg-[#C59560] hover:shadow-none hover:translate-y-1 transition-all duration-300 cursor-pointer">
              Mulai
            </button>
            <div className="flex">
              <img src={pf1} className="h-10 sm:h-12 md:h-16 lg:h-20 border-3 md:border-4 lg:border-5 border-white rounded-full" alt="" />
              <img src={pf2} className="h-10 sm:h-12 md:h-16 lg:h-20 -ml-4 sm:-ml-6 md:-ml-8 lg:-ml-10 border-3 md:border-4 lg:border-5 border-white rounded-full" alt="" />
              <img src={pf3} className="h-10 sm:h-12 md:h-16 lg:h-20 -ml-4 sm:-ml-6 md:-ml-8 lg:-ml-10 border-3 md:border-4 lg:border-5 border-white rounded-full" alt="" />
              <img src={pf4} className="h-10 sm:h-12 md:h-16 lg:h-20 -ml-4 sm:-ml-6 md:-ml-8 lg:-ml-10 border-3 md:border-4 lg:border-5 border-white rounded-full" alt="" />
              <img src={pf5} className="h-10 sm:h-12 md:h-16 lg:h-20 -ml-4 sm:-ml-6 md:-ml-8 lg:-ml-10 border-3 md:border-4 lg:border-5 border-white rounded-full" alt="" />
      ...
      <div className="relative mt-6 md:mt-14">
        {/* Mascot4 — hidden on mobile, positioned properly on desktop */}
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-end md:-mt-50 text-white bg-linear-to-r from-[#3338A0] to-[#4A50CE] w-full gap-4 md:gap-6 lg:gap-10 py-8 md:py-12 lg:py-16 px-6 md:pl-52 lg:pl-64 md:pr-12 lg:pr-24 rounded-[30px] md:rounded-[50px] animate-on-scroll" data-animation="animate-fade-up">
          <div className="px-6 md:px-9 py-5 md:py-10 lg:py-14 bg-[#777BDB] rounded-2xl md:rounded-3xl">
            <h3 className="font-pjs font-bold text-2xl md:text-3xl lg:text-4xl text-center mb-2 md:mb-4">2,5 JT+</h3>
            <p className="font-pjs font-medium text-sm md:text-base lg:text-xl text-center">Tuli & Gangguan Pendengaran di Indonesia</p>
          </div>
          <div className="px-6 md:px-9 py-5 md:py-10 lg:py-14 bg-[#777BDB] rounded-2xl md:rounded-3xl">
            <h3 className="font-pjs font-bold text-2xl md:text-3xl lg:text-4xl text-center mb-2 md:mb-4">80%</h3>
            <p className="font-pjs font-medium text-sm md:text-base lg:text-xl text-center">Tidak mendapat pendidikan bahasa isyarat formal</p>
          </div>
          <div className="px-6 md:px-9 py-5 md:py-10 lg:py-14 bg-[#777BDB] rounded-2xl md:rounded-3xl">
            <h3 className="font-pjs font-bold text-2xl md:text-3xl lg:text-4xl text-center mb-2 md:mb-4">&lt; 5%</h3>
            <p className="font-pjs font-medium text-sm md:text-base lg:text-xl text-center">Masyarakat umum yang memahami SIBI</p>
          </div>
        </div>
      </div>
    </section>
