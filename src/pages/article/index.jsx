...
const DetailArtikel = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="pt-24 md:pt-32 min-h-screen font-pjs px-4 md:px-12 lg:px-24 xl:px-36">
        <BackButton to="/konten" variant="gray" />

        <div className="pr-0 md:pr-10 lg:pr-20 mb-16 md:mb-28 mt-6 md:mt-10">
          <div className="flex flex-col gap-5 mb-12">
            <h2 className='text-black text-2xl md:text-3xl lg:text-4xl font-bold'>{article.title}</h2>
            <p className='text-black/70 text-base md:text-lg'>{article.date}</p>
          </div>
          ...
          <div className="flex items-center justify-between mb-10">
            <p className='text-black/70 text-base md:text-xl font-medium'>{article.views} Tayangan</p>
            <div className="flex gap-3 md:gap-5 text-black font-medium text-sm md:text-lg">
          ...
          <div className="flex flex-col gap-6 md:gap-10 text-black text-base md:text-lg lg:text-2xl max-w-full lg:max-w-9/10 ml-0 md:ml-4 lg:ml-8 whitespace-pre-wrap">
            <p>{article.content}</p>
          </div>
        </div>

        <div className="mb-16 md:mb-28 animate-on-scroll" data-animation="animate-fade-up">
          <h2 className='font-bold text-2xl md:text-3xl lg:text-4xl text-black mb-6 md:mb-8'>Artikel Terkait</h2>
