        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-8 md:mt-12 px-0 md:px-10 gap-4 md:gap-0 animate-on-scroll" data-animation="animate-fade-up">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 md:gap-5">
            {TAGS.map((tag) => (
              <div
                key={tag}
                className="py-2 md:py-2.5 px-6 md:px-12 border-1 border-black rounded-full font-pjs font-bold text-base md:text-xl lg:text-2xl hover:bg-[#3338A0] hover:text-white hover:border-[#3338A0] transition-all duration-300 cursor-pointer"
              >
                {tag}
              </div>
            ))}
