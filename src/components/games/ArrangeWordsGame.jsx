  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-10 md:gap-16">
      ...
      <div className="flex flex-col gap-3 w-full max-w-3xl items-center pt-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4 md:gap-6 w-full lg:w-auto px-4 lg:px-8 pb-4">
          {shuffledOptions.map((item, idx) => {
            ...
            return (
              <div 
                ...
                className={`relative w-[65px] h-[65px] sm:w-[85px] sm:h-[85px] md:w-[130px] md:h-[130px] rounded-2xl border-[2.5px] border-dashed flex flex-col items-center justify-center p-2 md:p-4 transition-all shadow-md overflow-hidden ${
                  isUsed 
      ...
      <div className="flex flex-col gap-3 w-full max-w-3xl items-center pb-8 border-t border-white/20 pt-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-8 w-full px-4 lg:px-8 pb-4">
          {filledSlots.map((handId, idx) => {
            ...
            return (
              <div 
                ...
                className={`relative w-[65px] h-[65px] sm:w-[85px] sm:h-[85px] md:w-[120px] md:h-[120px] rounded-2xl border-[2.5px] shadow-inner shrink-0 flex flex-col items-center justify-center p-2 md:p-4 transition-all overflow-hidden ${
                  hand 
